...
export const style = {
    simple_light: {
        ...
        hero_title: "font-medium text-8xl",
    ...
    simple_dark: {
        ...
        hero_title: "font-semibold text-8xl",
        hero_text: "font-light",
    ...
    gradient_light: {
        ...
        hero_title: "font-thin text-9xl",
        hero_text: "uppercase font-medium text-sm",
    ...
    neubrutalist: {
        ...
        hero_btn_img: change_darkgray,
        hero_title: "text-blue-900 font-black text-8xl",
